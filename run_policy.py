...
racecar_gym_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "racecar_gym"
)
...
def run_policy(
    model_path: str,
    env_name: str = "SingleAgentAustria-v0",
    num_episodes: int = 5,
    render: bool = True,
    max_steps: int = 1000,
